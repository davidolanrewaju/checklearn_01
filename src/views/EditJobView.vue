...
const handleSubmit = async () => {
  ...
  try {
    ...
    console.log('Error storing job: ' + error);
...
<template>
  <section class="bg-green-50">
    <div class="container m-auto max-w-2xl py-24">
      <form @submit.prevent="handleSubmit" class="bg-white px-6 py-8 mb-4 shadow-md rounded-md border m-4 md:m-0">
          ...
          <div class="mb-4">
            ...
            <input
              ...
              placeholder="eg. Full Stack Vue Developer"
              required
            />
          </div>
          <div class="mb-4">
